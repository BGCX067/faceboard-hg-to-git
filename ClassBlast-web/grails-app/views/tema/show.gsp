			...
			<ol class="property-list tema">
				...
				<li class="fieldcontain">
					<span id="sectionRelated-label" class="property-label"><g:message code="tema.sectionRelated.label" default="Section Related" /></span>
						...
						<span class="property-value" aria-labelledby="sectionRelated-label"><g:link controller="seccion" action="show" id="${temaInstance?.sectionRelated?.id}">${temaInstance?.sectionRelated?.encodeAsHTML()}</g:link></span>
