			...
			<ol class="property-list apunte">
				...
				<li class="fieldcontain">
					<span id="section-label" class="property-label"><g:message code="apunte.section.label" default="Section" /></span>
						...
						<span class="property-value" aria-labelledby="section-label"><g:link controller="seccion" action="show" id="${apunteInstance?.section?.id}">${apunteInstance?.section?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${apunteInstance?.homeworkList}">
				<li class="fieldcontain">
					<span id="homeworkList-label" class="property-label"><g:message code="apunte.homeworkList.label" default="Homework List" /></span>
					
						<g:each in="${apunteInstance.homeworkList}" var="h">
