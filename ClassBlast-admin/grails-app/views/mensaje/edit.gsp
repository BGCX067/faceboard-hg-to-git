...
<html>
	...
	<body>
		<a href="#edit-mensaje" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-mensaje" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:mensajeInstance, action:'update']" method="PUT" >
