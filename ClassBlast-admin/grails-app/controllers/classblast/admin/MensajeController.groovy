...
class MensajeController {
    ...
    def save(Mensaje mensajeInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'mensajeInstance.label', default: 'Mensaje'), mensajeInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'mensajeInstance.label', default: 'Mensaje'), params.id])
                redirect action: "index", method: "GET"
            }
